$(document).ready(function () {
    ...
    function arrayHunt() {
        ...
        for(var i = 0; i < myArray.length; i++)
        {
            ...
            {
                if(myArray[k].length > myArray[i].length){
                    var longest = [myArray[k]];
        ...
        var newArray = [];
        for(var i = 0; i < myArray.length; i++) {
            var newVar = myArray[i];


            newVar = newVar.replaceAll("a", "A");
            newVar = newVar.replaceAll("e", "E");
            newVar = newVar.replaceAll("i", "I");
            newVar = newVar.replaceAll("o", "O");
            newVar = newVar.replaceAll("u", "U");

            newArray.push(newVar);

        }

        $('td#upperVowels').text(newArray);
        ...
        var dash = reverse.join("-")

        $('td#reverseDash').text(dash);
